...
class ACTTemplateTest extends AnyFlatSpec with Matchers:
  "Apache Commons Text template" should "render a template correctly" in {
    ACTTemplateEngine()("p1 = ${ph:property1}, p2 = ${ph:property2}, user = ${env:USER}").apply(
