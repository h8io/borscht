...
object ValueTypeBigInt extends ValueTypePlain[BigInt]:
  override def parse(value: String): BigInt = BigInt(value)

object ValueTypeBigDecimal extends ValueTypePlain[BigDecimal]:
  override def parse(value: String): BigDecimal = BigDecimal(value)


object ValueTypeByte extends ValueTypePlain[Byte]:
...
object ValueTypeDouble extends ValueTypePlain[Double]:
...
object ValueTypeFloat extends ValueTypePlain[Float]:
...
object ValueTypeInt extends ValueTypePlain[Int]:
...
object ValueTypeLong extends ValueTypePlain[Long]:
...
object ValueTypeShort extends ValueTypePlain[Short]:
