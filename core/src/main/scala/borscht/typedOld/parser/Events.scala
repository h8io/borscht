...
import borscht.typedOld.parser.Events.{SingleCharacterTypeName, TypeNameSpecialChars}

import scala.annotation.tailrec
import scala.collection.BitSet

private[typedOld] final class Events(chars: IndexedSeq[Char]) extends (Parser => Parser) with Iterator[Event]:
  import Event.*
